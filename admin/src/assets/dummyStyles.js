...
searchContainer: "flex items-center gap-3 w-full max-w-lg",


searchInputContainer: "flex items-center bg-white border border-green-200 rounded-full px-3 py-2 shadow-sm flex-1",
searchIcon: "w-5 h-5 text-green-500 mr-2",
searchInput: "outline-none w-full bg-transparent text-sm border-none focus:ring-0",
...
clearButton: "px-3 py-2 bg-green-500 text-white rounded-full shadow hover:bg-green-600 shrink-0",
