...
import { Home, UserPlus, User, Calendar, Grid, PlusSquare, List, Users, Menu, X } from "lucide-react";
...
console.warn("could not retrive the token " ,err)
    }
  };
  storeToken();
  return() =>{
    ...
    <header className={ns.header}>
        <nav className={ns.navbarContainer}>
            ...
            <div className={ns.centerNavContainer}>
              ...
              className={ns.centerNavContainer}
...
function CenterNavItem({to,icon,label}){
    return(
        ...
        className={({ isActive }) =>`nav-item ${isActive ? "active" : ""} ${ns.centerNavItemBase} ${
