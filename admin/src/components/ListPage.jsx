...
import { Search, Users, Star, EyeClosed, Trash, BadgeIndianRupee} from 'lucide-react';
...
//it will normalize any date as string
...
// this function will normalize schedule map: ex- "YYYY-MM-DD" :[SLOT-1, SLOT-2...];
...
//this function will give past date first
//that is nearest date come first
...
const ListPage = () => {
  ...
  // to fetch doctor from the server
