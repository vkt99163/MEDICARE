...
const AppointmentsPage = () => {
  ...
  //if admin want to cancel to appointment
            ...
            w-full sm:w-auto'>
                <div className={pageStyles.searchContainer}>
                  ...
                  <input
                    ...
                    placeholder='Search doctor, patients,speciality'
                    value={query}
          ...
          {loading ? (
            ...
            <main className={pageStyles.gridContainer}>
              {displayed.map((a, idx) => {
                ...
                const isCancelled =
                  statusLower === "canceled" || statusLower === "completed";
                const isCompleted = statusLower === "completed";
