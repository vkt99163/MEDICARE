...
import { dashboardStyles as s } from "../assets/dummyStyles";
 import {BadgeIndianRupee, CalendarRange, CheckCircle, Users, XCircle,UserCheck, Search} from "lucide-react";
  ...
  useEffect(() => {
    ...
    async function loadDoctors() {
      ...
      try {
        ...
        let list = [];
        console.log("Doctors length:", list.length);
...
//           const yyo = await res.json();
// console.log("Doctors API:", yyo);
        if (!res.ok) {
            ...
            <div className={s.headerContainer}>
                <div>
                    ...
                    <p className={s.headerSubtitle}>
                      Overview of doctors & appointment
                    </p>
                </div>
        ...
        <div className={s.mobileDoctorCard}>
            <div className={s.mobileDoctorHeader}>
                <div className=" flex item-center gap-3">
                    ...
                    <div>
                    <div className={s.mobileDoctorName}>{d.name}
                    </div>
