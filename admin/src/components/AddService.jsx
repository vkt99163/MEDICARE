...
import { AlertTriangle, CheckCircle, Clock, XCircle, Image, Plus, Trash2, Calendar } from 'lucide-react';
...
const AddService = ({ serviceId }) => {
    ...
    //User can't select select previous date or month that is passsed from today
    useEffect(() => {
                ...
                {toast && (
                    <div className={`${addServiceStyles.toast.toastBase} ${toast.type === "error" ? addServiceStyles.toast.toastError :
                        toast.type === "info" ? addServiceStyles.toast.toastInfo :
                            addServiceStyles.toast.toastSuccess}animate-slideIn`}>
                        ...
                        <button onClick={() => setToast(null)}
                            ...
                            <XCircle className=' w-4 h-4 text-grey-400 hover:text-grey-600' />
