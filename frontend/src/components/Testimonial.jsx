...
import AnjaliImg from "../assets/Anjali.avif";
...
const Testimonial = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      role: "Patient",
      rating: 5,
      text: "Yaha par bandaro kaa bhi appointment book ho jata hai!",
      image:
        vivekImg,
      type: "patient",
    },
    ...
    <div className={testimonialStyles.container}>
      <div className={testimonialStyles.headerContainer}>
        ...
        <p className={testimonialStyles.subtitle}>
          Real stories from doctors and patients sharing their positive experiences
          with out healthcare platform.
