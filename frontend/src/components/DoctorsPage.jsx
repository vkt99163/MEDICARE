...
const DoctorsPage = () => {
    ...
    // Load the doctors coming fron the server side:
    useEffect(() => {
        let mounted = true;
        async function load() {
            setLoading(true);
        ...
        <div className={doctorsPageStyles.mainContainer}>
            ...
            <div className={doctorsPageStyles.wrapper}>
                ...
                {loading ? (
                    ...
                    <div className={`${doctorsPageStyles.doctorsGrid} ${filteredDoctors.length === 0 ?
                        ...
                        {displayedDoctors.length > 0 ? (
                            ...
                            <div key={doctor.id || `${doctor.name}-${index}`}
                                className={`${doctorsPageStyles.doctorCard}  ${doctorsPageStyles.doctorCard}${!doctor.available ? doctorsPageStyles.doctorCardUnavailable : ""}`}
                                style={{
