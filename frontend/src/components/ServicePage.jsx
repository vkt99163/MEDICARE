        ...
        {loading ? (
            <section className={servicePageStyles.skeletonGrid}>
                {Array.from({length: 8}).map((_i,i)=>(
                    <div key={i} className={servicePageStyles.ServiceCard}>
                    <div key={i} className={servicePageStyles.skeletonImage}></div>
                      <div key={i} className={servicePageStyles.skeletonText1}></div>
                        <div key={i} className={servicePageStyles.skeletonText2}></div>
                          <div key={i} className={servicePageStyles.skeletonButton}></div>
