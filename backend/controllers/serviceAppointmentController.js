...
//confirm the service payment 
 export const confirmServicePayment= async (req,res)=>{
  try{
    ...
    if(!stripe) return res.status(500).json({
      success:false,
      message:"Striped is not configured"
    })
  let session;
 ...
 export const getServiceAppointments= async (req,res) =>{
  try{
    ...
    console.error("get ServiceAppointment Error:", error);
    return res.status(404).json({
      success:false,
 ...
 export const getServiceAppointmentById = async(req,res)=>{
  try{
    ...
    return res.json({success:true, data:appt});
       ...
       console.error("get Service AppointmentById Error:", err);
    return res.status(404).json({
      success:false,
      message:"Server error"
    })
...
//first check wheather it filled if yes then update the field
...
return res.json({success:true, data:updated});
 ...
 console.error(" ServiceAppointment Error:", error);
    return res.status(404).json({
      success:false,
      message:"Server error"
    })
...
console.error(" Cancel ServiceAppointment Error:", error);
    return res.status(404).json({
      success:false,
      message:"Server error"
    })
 ...
 export const getServiceAppointmentStats= async (req,res) =>{
...

  {
    ...
    //cancel appointment and total earning done by them
     return res.json({
      success:true,
      services,
    ...
    console.error(" ServicegetAppointmentstats Error:", error);
    return res.status(404).json({
      success:false,
      message:"Server error"
    })
...
if (!resolvedCreatedBy && !mobile) {
 ...
 return res.json({
  ...
  data:list
    ...
    console.error(" get service appointmentbypatient  Error:", error);
